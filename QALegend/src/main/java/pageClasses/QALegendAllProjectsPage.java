...
public class QALegendAllProjectsPage {
	...
	@FindBy(xpath = "//a[text()='TitleUser82990']")
	WebElement allProjectCell;
	...
	public String getAllProjectCellValue() {
		String name = PageUtilities.getTextFromAnElement(allProjectCell);
		return name;
	}
